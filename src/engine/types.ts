...
export type Allergene = "soya" | "arachides" | "sesame" | "gluten" | "lactose" | "oeufs";

/** Catégorie d'épicerie d'un ingrédient. */
export type Cat = "F" | "L" | "P" | "G" | "C" | "N" | "D" | "E" | "S";

/** [nom, quantité par portion, unité, catégorie] */
export type Ingredient = [string, number, string, Cat];
...
export const CAT_NOMS: Record<Cat, string> = {
  ...
  E: "Épices & condiments", S: "Conserves & surgelés",
};
